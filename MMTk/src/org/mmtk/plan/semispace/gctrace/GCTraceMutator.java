 ...
 *
 * See {@link GCTrace} for an overview of the GC nurseryTrace algorithm.
 *
 * @see SSMutator
 * @see GCTrace
...
@Uninterruptible public class GCTraceMutator extends SSMutator {
  ...
  public final void postAlloc(ObjectReference object, ObjectReference typeRef,
    ...
    /* Make the nurseryTrace generator aware of the new object. */
    TraceGenerator.addTraceObject(object, allocator);

    super.postAlloc(object, typeRef, bytes, allocator);

    /* Now have the nurseryTrace process aware of the new allocation. */
