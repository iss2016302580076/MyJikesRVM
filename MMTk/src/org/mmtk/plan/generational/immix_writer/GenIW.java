 ...
 */
@Uninterruptible
public class GenIW extends Gen {
    ...
    /** The nurseryTrace class for a full-heap collection */
    ...
    protected void registerSpecializedMethods() {
        TransitiveClosure.registerSpecializedScan(SCAN_IMMIX, GenIWMatureTraceLocal.class);
