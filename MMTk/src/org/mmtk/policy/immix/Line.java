...
public class Line {
  ...
  public static Address align(Address ptr) {
    System.out.println(ptr.toWord());
    System.out.println(ptr.toWord().and(LINE_MASK.not()));
    System.out.println(ptr.toWord().and(LINE_MASK.not()).toAddress());
  ...
  */
  ...
  public static int getNextUnavailable(Address baseLineAvailAddress, int line, final byte unavailableState) {
    System.out.println(baseLineAvailAddress);
    System.out.println(Offset.fromIntZeroExtend(line << Line.LOG_BYTES_IN_LINE_STATUS));
    System.out.println(baseLineAvailAddress.loadByte(Offset.fromIntZeroExtend(line << Line.LOG_BYTES_IN_LINE_STATUS)));
