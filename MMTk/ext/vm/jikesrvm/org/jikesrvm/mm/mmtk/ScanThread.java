...
@Uninterruptible public final class ScanThread {
   ...
   * @param trace The nurseryTrace instance to use for reporting references.
   ...
   *
   * @param trace the nurseryTrace on which {@link TraceLocal#reportDelayedRootEdge(Address)}
   *  will be called
   ...
   *
   * @param trace The nurseryTrace instance to use for reporting locations.
