...
@Uninterruptible public abstract class Scanning {
   ...
   * encountered.
   *
   * @param trace the nurseryTrace to use for scanning
   ...
   * @param trace The nurseryTrace the method has been specialized for
   * @param object The object to be scanned
   */
   ...
   * such a space exists.
   *
   * @param trace The nurseryTrace object to use to report root locations.
   */
