...
public final class SanityRootTraceLocal extends TraceLocal {
  ...
  /**
   * Copy root values across to the 'real' single-threaded nurseryTrace that will do
   * the sanity checking.
   *
   * @param trace the nurseryTrace that will do the sanity checking
   */
  @Inline
  ...
  /**
   * Will this object move from this point on, during the current nurseryTrace ?
   *
