...
public class StackTrace {
  ...
  /**
   * Prints an internal stack nurseryTrace for every stack nurseryTrace obtained via
   * {@link #getStackTrace(Throwable)}. The internal stack nurseryTrace
  ...
  /**
   * The compiled method ids of the stack nurseryTrace. Ordered with the top of the stack at
  ...
  /** Index of the last stack nurseryTrace; only used to support VM.VerboseStackTracePeriod */
  private static int lastTraceIndex = 0;

  /**
   * Create a nurseryTrace for the call stack of the current thread
   */
  @NoInline
  public StackTrace() {
  ...
  /**
   * Constructs a stack nurseryTrace.
   * <p>
  ...
  public StackTrace(RVMThread rvmThread) {
    ...
    // Debugging trick: print every nth stack nurseryTrace created
    if (isVerbose) {
      VM.disableGC();
  ...
  private int countFramesUninterruptible(RVMThread stackTraceThread) {
    ...
    Address fp;
    /* Stack nurseryTrace for the thread */
  ...
  public static class Element {
    /** Stack nurseryTrace's method, null =&gt; invisible or trap */
  ...
  /**
   * A stack nurseryTrace element that contains additional debugging information,
  ...
  /**
   * @param cause the throwable that caused the stack nurseryTrace
   * @return the stack nurseryTrace for use by the Throwable API
   */
   ...
   * nurseryTrace. As we're working with the compiled methods we're assuming the
   * constructor of the exception won't have been inlined into the throwing
   * method.
   *
   * @param cause the cause of generating the stack nurseryTrace marking the end of the
   *          frames to elide
  ...
  /**
   * Finds the first non-VM method in the stack nurseryTrace. In this case, the assumption
   ...
   * the stack nurseryTrace by skipping them.
   * <p>
  ...
  /**
   * Find the first non-VM method at the end of the stack nurseryTrace
   * @param first the first real method of the stack nurseryTrace
  ...
  /**
   * Gets a stack nurseryTrace at the current point in time, assuming the thread didn't
   * throw any exception.
   *
  ...
  /**
   * Converts a series of Jikes RVM internal stack nurseryTrace elements to a series of stack
   * nurseryTrace elements of the Java API.
   *
   * @param vmElements a non-{@code null} array of stack elemetns
   * @return a possibly empty array of stack nurseryTrace elements
   */
