 ...
 * eliminate redundant tests on the common-case nurseryTrace.
 * <p>
 ...
 * execution in the uncommon-case nurseryTrace that might have
 * been able to use a subset of to common-case nurseryTrace.
 */
public class StaticSplitting extends CompilerPhase {
   ...
   *      create a common case nurseryTrace. For example,
   ...
   * @return the off-nurseryTrace successor of b
