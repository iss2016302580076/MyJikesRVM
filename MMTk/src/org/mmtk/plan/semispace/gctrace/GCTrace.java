 ...
 * for GC nurseryTrace generation.  To maximize performance, it attempts to remain
 * as faithful as possible to semiSpace/Plan.java.
 *
 * The generated nurseryTrace format is as follows:
 * <pre>
 *    B 345678 12
...
@Uninterruptible public class GCTrace extends SS {
   ...
   *
   */
  public static final RawPageSpace traceSpace = new RawPageSpace("nurseryTrace", VMRequest.discontiguous());
  ...
  public static boolean traceInducedGC = false; // True if nurseryTrace triggered GC
   ...
   * nurseryTrace process to finish.
   */
  @Override
  @Interruptible
  ...
  public void collectionPhase(short phaseId) {
    ...
    if (phaseId == RELEASE) {
      if (traceInducedGC) {
        /* Clean up following a nurseryTrace-induced scan */
        deathScan = false;
      } else {
  ...
  /**
   * @return Since nurseryTrace induced collections are not called to free up memory,
