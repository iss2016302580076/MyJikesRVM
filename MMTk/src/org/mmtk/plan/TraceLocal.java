 ...
 * (ie the 'fast path') of the nurseryTrace mechanism.
 *
...
public abstract class TraceLocal extends TransitiveClosure {
  ...
  /**
   * This method is the core method during the nurseryTrace of the object graph.
   ...
   * override this method in each of their nurseryTrace classes.</i>
   *
