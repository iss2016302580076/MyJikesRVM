 ...
 */
@Uninterruptible public class GenMyCopy extends Gen {
  ...
  public GenMyCopy() {
    super();
    //can not ingore rememberSets
    if (VM.VERIFY_ASSERTIONS) VM.assertions._assert(!IGNORE_REMSETS); // Not supported for GenMyCopy
  ...
  protected void registerSpecializedMethods() {
    TransitiveClosure.registerSpecializedScan(SCAN_MATURE, GenMyCopyMatureTraceLocal.class);
