 ...
 */
@Uninterruptible
public final class GenMyCopyMatureTraceLocal extends GenMatureTraceLocal {

  /**
   * @param global the global nurseryTrace class to use
   * @param plan the state of the generational collector
   */
  public GenMyCopyMatureTraceLocal(Trace global, GenCollector plan) {
    super(global, plan);
  }
  ...
  public ObjectReference traceObject(ObjectReference object) {
    ...
    if (Space.isInSpace(GenMyCopy.MS0, object))
      return GenMyCopy.matureSpace0.traceObject(this, object, Gen.ALLOC_MATURE_MAJORGC);
    if (Space.isInSpace(GenMyCopy.MS1, object))
      return GenMyCopy.matureSpace1.traceObject(this, object, Gen.ALLOC_MATURE_MAJORGC);
  ...
  public boolean isLive(ObjectReference object) {
    ...
    if (Space.isInSpace(GenMyCopy.MS0, object))
      return GenMyCopy.hi ? GenMyCopy.matureSpace0.isLive(object) : true;
    if (Space.isInSpace(GenMyCopy.MS1, object))
      return GenMyCopy.hi ? true : GenMyCopy.matureSpace1.isLive(object);
  ...
  public boolean willNotMoveInCurrentCollection(ObjectReference object) {
    if (Space.isInSpace(GenMyCopy.toSpaceDesc(), object)) {
      return true;
    }
    if (Space.isInSpace(GenMyCopy.fromSpaceDesc(), object)) {
      return false;
    }
