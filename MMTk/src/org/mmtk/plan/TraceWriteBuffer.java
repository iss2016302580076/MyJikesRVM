...
/**
 * This class is used to push values in one direction during a nurseryTrace. It
...
public final class TraceWriteBuffer extends TransitiveClosure {
  ...
  /**
   * Flush the buffer to the nurseryTrace.
   */
  public void flush() {
    buffer.flushLocal();
  }
  ...
  /**
   * Enqueue an object during a nurseryTrace.
   *
