  ...
  private static boolean checkEscapesMethod(RegisterOperand use, IR ir, Set<Register> visited) {
    ...
    try {
      ...
      case CALL_opcode: {
        ...
        // constructor, we know the constructor would only fill in the stack nurseryTrace.
        // If the stack nurseryTrace is unnecessary, we can replace the call to the Throwable
        // constructor.
        MethodOperand mop = Call.getMethod(inst);
