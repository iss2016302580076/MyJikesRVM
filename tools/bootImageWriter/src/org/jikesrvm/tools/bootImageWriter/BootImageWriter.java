 ...
 *    -nurseryTrace                   talk while we work? (increment "verbose")
...
public class BootImageWriter {
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < args.length; ++i) {
      ...
      // generate nurseryTrace messages while writing bootimage (for debugging)
      if (args[i].equals("-nurseryTrace")) {
