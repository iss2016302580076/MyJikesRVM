...
public final class ImmixSpace extends Space {
  ...
  */
   ...
   *
   * @param trace The nurseryTrace performing the transitive closure
   ...
   * nurseryTrace method, so we always return the same object: this could be a
   ...
   * the scan phase (which occurs after the nurseryTrace phase), presumably because
