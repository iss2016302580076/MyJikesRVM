 ...
 *
 * Specifically, this class defines <i>MyGC</i> mutator-time allocation
 ...
 */
@Uninterruptible
public class MyGCMutator extends MutatorContext {
   ...
   *
   */
  private final ImmortalLocal nogc = new ImmortalLocal(MyGC.noGCSpace);
  ...
  public Address alloc(int bytes, int align, int offset, int allocator, int site) {
    if (allocator == MyGC.ALLOC_DEFAULT) {
  ...
  public Allocator getAllocatorFromSpace(Space space) {
    if (space == MyGC.noGCSpace) return nogc;
